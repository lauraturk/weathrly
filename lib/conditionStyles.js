import WeatherBackgrounds from './WeatherBackgrounds'
 ...
 const conditionStyles = (conditions) => {
   var keys = Object.keys(WeatherBackgrounds)
 ...
 //   if(WeatherBackgrounds[conditions.icon.toLowerCase()]){
 //     document.body.style.backgroundImage = WeatherBackgrounds[conditions.icon.toLowerCase()]
 //
 //   }
 //  // night clear
 //   else if (conditions.icon.toLowerCase().includes('nt_clear')) {
 ...
 //
 //   } else if (conditions.icon.toLowerCase().includes('clear')) {
 //     document.body.style.backgroundImage = "url('../styles/pics/sunny.jpeg')"
 //
 //   //cloudy
